...
class PeptideBuilder:
    ...
    def click_cyclize_peptide(self, linear_peptide: MolecularGraph) -> MolecularGraph:
        ...
        # Create additional nitrogen for triazole ring (position 3)
        n3 = GraphNode(
            id=max_id + 1,
            element='N',
            atomic_num=7,
        ...
        # Add new atoms
        cyclic.nodes.extend([n3, c4, c5])

        # Create triazole ring bonds (5-membered ring)
        triazole_bonds = [
            # N1-N2
            GraphEdge(
