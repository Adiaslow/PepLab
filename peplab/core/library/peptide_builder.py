...
class PeptideBuilder:
    ...
    def click_cyclize_peptide(self, linear_peptide: MolecularGraph) -> MolecularGraph:
        ...
        # Create N1 (connected to azide CH2 chain)
        n1 = GraphNode(
            id=max_id + 1,
            element='N',
            atomic_num=7,
        ...
        n2 = GraphNode(
            ...
            atomic_num=7,
            formal_charge=0,
            implicit_valence=2,  # One single + one double bond
            explicit_valence=2,
            aromatic=True,
            hybridization='SP2',
            num_explicit_hs=0,
        ...
        # Create C4 (connected to alkyne CH2)
        c4 = GraphNode(
            id=max_id + 4,
            element='C',
            atomic_num=6,
        ...
        # Create 1,4-disubstituted triazole ring bonds
        triazole_bonds = [
            # N1-N2
            GraphEdge(
                from_idx=n1.id,
        ...
        # Connect to peptide chains
        connection_bonds = [
            # N1 to azide CH2 chain
            GraphEdge(
                from_idx=n1.id,
