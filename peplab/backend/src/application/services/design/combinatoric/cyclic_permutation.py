# peplab/backend/src/application/services/design/combinatoric/cyclic_permutation.py
"""
This module defines the CyclicPermutative class for generating cyclic permutations of items.

Classes:
    CyclicPermutative: A class for generating cyclic permutations of items.
"""
